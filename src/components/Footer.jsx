        ...
        <footer className="w-full py-8 bg-gray-900 text-white">
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-center mb-6">
                ...
                <ul className="flex space-x-6 mb-4 md:mb-0">
                    <li><a key="0" href="https://github.com/eshan-sud" className="hover:underline" rel="noopener noreferrer">GitHub</a></li>
                    <li><a key="1" href="https://www.linkedin.com/in/eshan-sud/" className="hover:underline" rel="noopener noreferrer">LinkedIn</a></li>
                </ul>
            </div>
