...
export const Navbar = () => {
    ...
    return (
        <>
            <div className={`bg-white/50 fixed top-0 z-50 p-4 w-full shadow-2xl border-solid border-b-[1px] border-black flex align-middle justify-between transition-transform duration-300 ${showNavbar ? 'transform translate-y-0' : 'transform -translate-y-full'}`}>
