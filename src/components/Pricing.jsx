        ...
        <div className="w-full py-16 bg-gray-100 text-center">
            ...
            <div className="flex flex-col items-center">
                <div className="bg-white p-8 rounded-lg shadow-lg max-w-sm">
                    ...
                    <button className="bg-blue-500 text-white py-2 px-4 rounded-full hover:bg-blue-600 transition duration-300" onClick={() => navigation('/register')}>Get Started</button>
                </div>
            </div>
        </div>
    );
