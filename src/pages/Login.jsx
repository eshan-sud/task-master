    ...
    <>
      ...
      <div class="flex flex-col p-4 text-black">
        ...
        <form class="flex flex-col gap-3" onSubmit={handleLogin}>
            ...
            <div><a class="text-sm text-[#ff4747]" href="#"> Forgot your password? </a></div>
      ...
      <div class="text-sm text-center mt-[1.6rem]">Don't have an account yet? <a class="text-sm text-[#ff4747]" href="#"> Sign up for free! </a></div>
